...
@onready var _name_label := $Background/NameLabel
@onready var _text_label := $Background/TextLabel
@onready var _indicator := $Background/Indicator
@onready var _timer := $Background/Timer


func _ready() -> void:
	_timer.wait_time = _text_speed
	#_dialog = _get_dialog()
	#_next_phrase()
